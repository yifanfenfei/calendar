...
@synthesize rightArrow = _rightArrow;//down——arrow
...
- (UIButton *)rightArrow
{
    if (_rightArrow == nil)
    {
       ...
       // [self addSubview:_rightArrow];//sun
    }
    return _rightArrow;
}
...
- (UIButton *)longRightArrow
{
    if (_longRightArrow == nil)
    {
        ...
        [self addSubview:_longRightArrow];//sun
    }
...
//        [self addSubview:self.titleButton];//sun
...
- (void)updateArrowsForProvider:(id<ABCalendarPickerDateProviderProtocol>)provider
{
    ...
    self.rightArrow.frame = CGRectMake(self.frame.size.width-40-(self.longRightArrow.hidden ? 0 : 35), 3, 40, 45);
    ...
    {
        self.longRightArrow.frame = CGRectMake(self.frame.size.width-35, 3, 35, 45);
