...
//  calendar
//
//  Created by sun jianfeng on 2/27/13.
...
{
    self.calendarShadow.frame = CGRectMake(CGRectGetMinX(self.calendarPicker.frame),CGRectGetMaxY(self.calendarPicker.frame),
